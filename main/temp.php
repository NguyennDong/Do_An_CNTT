...
<body>
        ...
        <ul class="nav nav-tabs" id="mainNav" style="border-bottom: none;">
            ...
            <li>
                ...
                if(isset($_SESSION['gv'])){
                    echo '<a data-toggle="tab" href="#giang_vien"><span><i class="fas fa-poll"></i></span> <span>GIẢNG VIÊN</span></a>';
                }else {
                    echo '';
                }
                ?>
    ...
    <div class="tab-content">
        ...
        <!-- ===========================KẾT QUẢ ĐĂNG KÝ============================ -->
        <div id="result" class="tabe-pane fade table_result" style="overflow-y: scroll;">
...
?>
        ...
        <div id="giang_vien" class="tabe-pane fade table_result" style="overflow-y: scroll;">
            <span class="title-list">Danh sách đề tài của giảng viên:</span><span><a data-toggle="modal"
                    data-target="#exampleModal" href="#">Tạo đề tài</a></span>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tạo đề tài</h5>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td id="amount-max">@1231232132132131232131231231232132131231</td>
                        <td id=""></td>
                    </tr>
                </tbody>
            </table>
